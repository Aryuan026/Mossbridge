...
REMOTE_URL="${MOSSBRIDGE_CODEX_ENDPOINT:-ws://127.0.0.1:${PORT}}"
STATE_DIR="${MOSSBRIDGE_STATE_DIR:-$HOME/.mossbridge}"
SESSION_FILE="${MOSSBRIDGE_SESSIONS_FILE:-${STATE_DIR}/sessions.json}"
WORKSPACE_ROOT="${MOSSBRIDGE_WORKSPACE_ROOT:-$PWD}"
ACCOUNT_DIR="${STATE_DIR}/accounts"
RUNTIME_ID="${MOSSBRIDGE_RUNTIME:-codex}"
CODEX_COMMAND="${MOSSBRIDGE_CODEX_COMMAND:-codex}"
