...
function prepareCodexCompanionProfile({ enabled = false, instructionsFile = "" } = {}) {
  ...
  return buildProfile({
    ...
    baseInstructions,
    baseInstructionsSha256: sha256(baseInstructions),
...
function buildCodexCompanionDiagnostics(profile = {}, { deliveryVerified = false } = {}) {
  return {
    ...
    base_instructions_sha256: profile.baseInstructionsSha256 || "",
    base_instructions_chars: profile.baseInstructionsChars || 0,
