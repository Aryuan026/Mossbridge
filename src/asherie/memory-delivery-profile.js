...
const AFFECTIVE_RELATIONAL_PATTERN = /(担心|怕|害怕|焦虑|不安|慌|难过|委屈|破防|崩了|想哭|哭了|冷冷|冷淡|生硬|工具化|公事公办|生疏|不熟|不对劲|不像|疏远|没得选|失去|丢掉|离开|分离|安全感|陪我)/iu;
...
function resolveMemoryDeliveryProfile({
  ...
  const includeAmbientWarm = ["ambient_warm", "heartbeat_lite"].includes(tier);
