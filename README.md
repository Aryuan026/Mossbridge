...
- `MOSSBRIDGE_BACKGROUND_RUNTIME_CIRCUIT_*` settings protect background check-in/dreaming turns after repeated first-event runtime failures. The circuit drops or defers only bridge-owned background turns; normal user messages still get visible diagnostics.
